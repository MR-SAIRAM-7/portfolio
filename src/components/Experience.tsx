          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-8">
              <div className="text-center">
                <a 
                  href="https://drive.google.com/file/d/1Tnrz37DGVl2U8Nf2PF4BwbFa42IUo814/view?usp=sharing" 
                  target="_blank" 
                ...
                >
                  ...
                  >
                    ...
                    <div className="absolute inset-0 bg-[#00FF41] transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300 origin-left pointer-events-none"></div>
                  </button>
                </a>
              </div>
